...
export const translations = {
  "pt-BR": {
    ...
    "leadsExtracted": "leads extraídos com sucesso!",
    "processingError": "Erro ao processar o link. Verifique se ele é válido.",
    "freePlanLimit": "Você atingiu o limite máximo de 50 leads no plano gratuito. Para continuar utilizando as funcionalidades, assine um dos nossos planos pagos.",
    "reports": "Relatórios",
  ...
  "en": {
    ...
    "leadsExtracted": "leads successfully extracted!",
    "processingError": "Error processing the link. Please verify if it's valid.",
    "freePlanLimit": "You have reached the maximum limit of 50 leads in the free plan. To continue using the features, subscribe to one of our paid plans.",
    "reports": "Reports",
  ...
  "es": {
    ...
    "leadsExtracted": "leads extraídos con éxito!",
    "processingError": "Error al procesar el enlace. Verifique si es válido.",
    "freePlanLimit": "Has alcanzado el límite máximo de 50 leads en el plan gratuito. Para continuar utilizando las funcionalidades, suscríbete a uno de nuestros planes pagos.",
    "reports": "Informes",
